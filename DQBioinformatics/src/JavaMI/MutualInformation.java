/**
 * *****************************************************************************
 ** MutualInformation.java * Part of the Java Mutual Information toolbox * *
 * Author: Adam Pocock * Created: 20/1/2012 * * Copyright 2012 Adam Pocock, The
 * University Of Manchester * www.cs.manchester.ac.uk * * This file is part of
 * MIToolboxJava. * * MIToolboxJava is free software: you can redistribute it
...
public abstract class MutualInformation {
    ...
    public strictfp static double calculateMutualInformation(double[] firstVector, double[] secondVector) {
        ...
        for (Integer key : state.jointProbMap.keySet()) {
            ...
            System.out.println(jointValue + "\t" + firstValue + "\t" + secondValue);
