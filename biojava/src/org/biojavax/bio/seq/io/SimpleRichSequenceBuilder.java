...
public class SimpleRichSequenceBuilder extends RichSeqIOAdapter implements RichSequenceBuilder {
    ...
    /**
     * Creates a new instance of SimpleRichSequenceBuilder using a
     * SimpleSymbolListFactory with a threshold of zero.
     */
    ...
    /**
     * Creates a new instance of SimpleRichSequenceBuilder with the desired
     * symbollistfactory and threshold of zero.
     *
    ...
    /**
     * Creates a new instance of SimpleRichSequenceBuilder with the desired
     * symbollistfactory and threshold.
     *
    ...
    /**
     * {@inheritDoc} The last accession passed to this routine will always be
     * the one used.
     */
        ...
        try {
            ...
            for (Iterator i = this.allFeatures.iterator(); i.hasNext();) {
                ...
                if (f.getName() == null || f.getName().length() == 0) {
                    f.setName(rs.getAccession() + "#" + f.getRank()); // dummy feature name for use in GBrowse
                }
            }
            rs.setDescription(this.description);
            rs.setSource(this.source);
    ...
    public void setSource(Source source) throws ParseException {
        if (this.source != null) {
            throw new ParseException("Current BioEntry already has a source");
        }
        this.source = source;
    }
