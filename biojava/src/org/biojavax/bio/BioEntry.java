...
/**
 * This class relates to the bioentry table in BioSQL. It holds everything you
 * need to define a non-sequence bearing bioentry.
 *
...
public interface BioEntry extends RichAnnotatable, RankedCrossRefable, Comparable, Changeable {
    ...
    public static final ChangeType SOURCE = new ChangeType(
            "This bioentry's source has changed",
            "org.biojavax.bio.BioEntry",
            "SOURCE"
    );
    ...
    /**
     * Returns the namespace of this bioentry. The namespace is supposed to be
     * an immutable property set by the constructor.
     *
    ...
    /**
     * Returns the name of this bioentry. The name is supposed to be an
     * immutable property set by the constructor.
     *
    ...
    /**
     * Returns the accession of this bioentry. The accession is supposed to be
     * an immutable property set by the constructor.
     *
    ...
    /**
     * Returns the division of this bioentry. Division relates to a division of
     ...
     */
    public NCBITaxon getTaxon(); // Reda modification

    /**
     * Sets the taxon for this bioentry. It may be null, in which case the taxon
     * is unset.
     *
    ...
    /**
     * Returns a set of all comments associated with this bioentry. This set is
     * not mutable. If no comments are associated, you will get back an empty
     * set.
     *
     ...
     * set is not mutable. If no relationships are associated, you will get back
     * an empty set.
     *
    ...
    //reda modifs
    /**
     * Sets the source for this bioentry.
     *
     * @param source New value of property source.
     * @throws ChangeVetoException in case of objections.
     */
    public void setSource(Source source) throws ChangeVetoException;

    /**
     * Returns a source of this sequence.
     *
