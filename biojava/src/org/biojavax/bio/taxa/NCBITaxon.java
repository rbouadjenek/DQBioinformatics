...
public interface NCBITaxon extends Comparable,Changeable {
     ...
     */
    public static final String EQUIVALENT_NAME = "equivalent name";
    /**
     * Use this to define equivalent names for things. There can be as many
     * equivalent names as you like.
     */
    public static final String GENBANK_COMMON_NAME = "genbank common name";
    /**
     * Use this to define equivalent names for things. There can be as many
     * equivalent names as you like.
     */
     ...
     * equivalent names as you like.
     */
    public static final String MISNOMER = "misnomer";
    
     /**
     * Use this to define equivalent names for things. There can be as many
     * equivalent names as you like.
     */
    public static final String MISSPELLING = "misspelling";
     /**
     * Use this to define equivalent names for things. There can be as many
     * equivalent names as you like.
     */
    public static final String TYPE_MATERIAL = "type material";
