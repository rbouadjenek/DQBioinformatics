...
public class StringTools {
    ...
    /**
     * Takes an input string and appends spaces to the left. Ignores any
     * existing leading whitespace when counting the indent size.
     *
    ...
    /**
     * Word-wraps a string into an array of lines of no more than the given
     * width. The string is split into chunks using the regex supplied to
     * identify the points where it can be broken. If a word is longer than the
     * width required, it is broken mid-word, otherwise the string is always
     * broken between words.
     *
     * @param input the string to format
     * @param sepRegex the regex identifying the break points in the string, to
     * be compiled using Pattern.
    ...
    /**
     * Writes some text to the output stream in the following format: key text
     * continuation of text where the key/wrappedKey column is keyWidth wide,
     * and the total line width is lineWidth, and the text is split over
     * multiple lines at the nearest occurrence of whitespace.
     *
     * @param key the key to write on the first line only
     * @param text the text to write out
     * @param keyWidth the width to indent the text by (in which the key will be
     * printed)
     ...
     * continuation of text where the key/wrappedKey column is keyWidth wide,
     * and the total line width is lineWidth, and the text is split over
     * multiple lines at the nearest occurrence of separator sep.
     *
     * @param key the key to write on the first line only
     * @param text the text to write out
     * @param keyWidth the width to indent the text by (in which the key will be
     * printed)
     * @param sep the separator to split the text on if it exceeds the line
     * width
     * @param os the stream to write the formatted output to
     */
    ...
    /**
     * Writes some text to the output stream in the following format: key text
     * wrappedKey continuation of text where the key/wrappedKey column is
     * keyWidth wide, and the total line width is lineWidth, and the text is
     * split over multiple lines at the nearest occurrence of separator sep.
     *
     * @param key the key to write on the first line only
     * @param text the text to write out
     * @param keyWidth the width to indent the text by (in which the key will be
    ...
    public static void writeKeyValueLine(String key, String text, int keyWidth, int lineWidth, String sep, String wrappedKey, PrintStream os) {
        ...
        if (wrappedKey == null) {
            wrappedKey = ""; // stop null pointer exceptions on wrapped keys
        }
        if (sep == null) {
            sep = "\\s+"; // stop null pointer exceptions on the separator
