...
public abstract class AbstractChangeable implements Changeable {
     ...
     * you want to set the Unchanging set on the ChangeSupport, or if you want
     * to install listeners on other objects when the change system is
     * initialized.
     *
     * @since 1.3
     */
     ...
     *
     * <p>
     * Your implementation of this method should have the following structure:      <code><pre>
   * ChangeSupport cs = super.getChangeSupport(ct);
     ...
     * </pre></code>
     *
     * It is usual for the forwarding listeners (someForwarder in this example)
     * to be transient and lazily instantiated. Be sure to register & unregister
     * the forwarder in the code that does the ChangeEvent handling in setter
     * methods.
     */
