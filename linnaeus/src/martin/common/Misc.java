...
public class Misc {
     ...
     * @param arr
     * @param separator
     * @return a string of all string representations of the objects in arr,
     ...
     * @param set
     * @param separator
     * @return a string of all string representations of the objects in set,
     * separated by separator
     */
    ...
    public static double[][] loadCSV(File file) {
        ArrayList<double[]> retres = new ArrayList<>();
     ...
     * This is useful for e.g. dates, where 2009-07-30 looks better than
     * 2009-7-30.
     *
     * @param data
     * @param desiredLength
     * @return a string of length desiredLength consisting of data and a number
     * of leading zeros
     */
