...
/**
 * Class representing a tagged document. Contains the original document, and the
 * tags found in that document by a matcher.
 *
 * @author Martin
 */
public class TaggedDocument {
    ...
    /**
     * Converts a document text, with given NER mentions, to e.g. HTML or XML
     * format (adding tags around the recognized mentions). When calling the
     * method, an alternative user-specific function can be provided of the
     * following signature: Pair<String> Function.function(Object[] args), where
     * the returned pair is the pair of tags enclosing the mention (e.g. <u> and
     * </u>) and the args is an array of [the mention, format, link]
     *
     ...
     * @param alternativeTagFunction potentially an alternative tagging function
     * (may be null)
     * @return the text of the document, with formatting tags added around the
     * specified mentions
     */
