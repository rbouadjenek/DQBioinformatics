 ...
 * transaction log is synchronized regularly and then restarted, so don't worry
 * if you see the size going up and down.
 *
...
public final class BaseRecordManager
    ...
    /**
     * if true, new records alwayes saved to end of file and free space is not
     * reclaimed. This may speed up some operations which involves lot of
     * updates and inserts (batch creation); You need to reopen store to apply
     * effect
     */
    ...
    /**
     * Underlying file for store records. Traces free records
     */
    private RecordFile _physFileFree;

    /**
     * Page manager for physical manager. Traces free records
     */
    ...
    /**
     * Underlying file for logical records. Traces free records
     */
    private RecordFile _logicFileFree;

    /**
     * Page manager for logical manager. Traces free records
     */
     ...
     * This way resulting number is smaller and can be easyer packed with
     * LongPacker
     */
